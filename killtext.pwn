/*
	Один із варіантів реалізації на практиці не перевіряв, тому може бути десь баг
...
stock killinfo(playerid, killerid) //сам сток, аргументи: playerid - жертва, killerid - вбивця
{
	...
	format(string, sizeof(string), "Час смерті {FFFF00}%d:%02d:%d | {FFFFFF}Дата: {FFFF00}%02d.%02d.%d", hour, minuite, second, month, day, year);
